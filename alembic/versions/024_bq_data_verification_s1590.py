...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("start_lease_owner_id", sa.String(length=36), nullable=True),
        sa.Column("start_lease_expires_at_utc", sa.DateTime(timezone=True), nullable=True),
        sa.Column("withdraw_requested_at_utc", sa.DateTime(timezone=True), nullable=True),
